    ...
    public static void main(String[] args) throws Exception {
        ...
        double initialB;
            ...
            for (int i = 0; i < 11; i++) {//for loop for the four testing experiments
                ...
                FileOutputStream out = new FileOutputStream(dir + "/Hybrid_Q_Learning_learningR" + PlayPDGQ.learningR + "_" + "discountR" + PlayPDGQ.discountR + "_" + "spreadR" + PlayPDGQ.activateChance + ".xlsx");
                workbook1.write(out);
                out.close();
