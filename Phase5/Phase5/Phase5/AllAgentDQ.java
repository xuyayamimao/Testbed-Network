...
public class AllAgentDQ {
    ...
    private List<AllAgentDQ> QNeighborList;//the list of an AgentQ's four neighbors, the AgentQs in the list don't change
    ...
    public List<AllAgentDQ> getQNeighborList() {
        return QNeighborList;
    }

    public void addToQNeighborList(AllAgentDQ a) {
        QNeighborList.add(a);
    }
