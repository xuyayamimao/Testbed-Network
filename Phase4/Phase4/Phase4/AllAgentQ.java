...
public class AllAgentQ {
    ...
    private List<AllAgentQ> QNeighborList;//the list of an AgentQ's four neighbors, the AgentQs in the list don't change
    ...
    public List<AllAgentQ> getQNeighborList() {
        return QNeighborList;
    }

    public void addToQNeighborList(AllAgentQ a) {
        QNeighborList.add(a);
    }
